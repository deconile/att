...
function loadPlans(){
    ...
    $('.plan-cards').each(function(){
        ...
        for(p = 0; p < plans[planKey].length; p++){
            ...
            const plancard = `
            <div class="plan-card flex col">
                <div class="card life plan neutral md radio">
                    <div class="image"><div><img src="${plans[planKey][p].lifestyle}" /></div></div>
            ...
            // CHECK FOR BOLT ONS
            if(plans[planKey][p].bolton){
                $(this).find('.card').eq(p).find('.content').append(boltOn);
                $(this).find('.card').eq(p).addClass('has-bolton');
                $(this).find('.icon-button').on('click', function(e){
                    e.stopPropagation();
                    toggleDrawer('#boltons');
                });
            }
...
function placeFeatures(){
    $('.plan-cards').find('.plan-card').append('<div class="accordions reveal"></div>')
...
<div id="features" class="accordion matching open">
...
<div class="frame sm base bordered mar-md-t flex middle">
...
const plans = {
    unlimited : [
        ...
        //             tooltip : 'After 50GB, mobile hotspot speed slowed to a maximum of 128Kbps.',
        //             legal : false,
        //         },
        //         {
        //             icon : '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path class="svg-base" d="M14.21 12.1h-1.5L8.85 17v1.36h3.77V20h1.59v-1.63h.94v-1.32h-.94zm-1.59 5h-2.19l2.19-2.77zM20 15.26L22.82 20h-2.11l-2-3.48-.9 1.1V20H16v-8h1.8v3.34L20.5 12h2.14zM28 6H4a3 3 0 00-3 3v14a3 3 0 003 3h24a3 3 0 003-3V9a3 3 0 00-3-3zm1 17a1 1 0 01-1 1H4a1 1 0 01-1-1V9a1 1 0 011-1h24a1 1 0 011 1z"/></svg>',
    ...
    <div class="content">
        <div class="wrapper">
            <div class="nutrition-label">
                ...
                <p style="margin-bottom:4px;">This Monthly Price is not an introductory rate.</p>
                <p>This Monthly Price does require a 36 month contract. <a href="">att.com/36MonthContractTerms</a></p>
                <p class="multi" style="margin-top:4px;">Get a $10 discount per line/per month with AutoPay and paperless billing.</p>
